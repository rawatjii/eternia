...
function SubmitQueryData(n, t,formid) {
    ...
    //     var recaptchaWidgetId1 = grecaptcha.getResponse(recaptchaWidgetId1);  // Get response for Form 1
	// 	$('.invalid-capthca-footer-form').remove();
	// 	if(recaptchaWidgetId1==''){
	// 		$("#"+formid).find('.captchadiv').after(`<div class="invalid-data invalid-capthca-footer-form" style="color:red;width:100%;padding-left: 10px;background-color: #ffffff;"> Please Check Captcha</div>`);
			
	// 	}

	// }else if(formid=='modalform'){
    //     var recaptchaWidgetId1 = grecaptcha.getResponse(recaptchaWidgetId2);  // Get response for Form 1
	// 	$('.invalid-capthca-footer-form').remove();
	// 	if(recaptchaWidgetId1==''){
	// 		$("#"+formid).find('.captchadiv').after(`<div class="invalid-data invalid-capthca-footer-form" style="color:red;width:100%;padding-left: 10px;background-color: #ffffff;"> Please Check Captcha</div>`);
